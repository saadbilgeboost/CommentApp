package com.saad.commentapp.utility;

import com.saad.commentapp.repository.entity.EUserType;
...
import com.saad.commentapp.service.ProductCommentService;
...
//   createLikes();
    ...
    public void createUser() {
        ...
        User user2 = User.builder().email("hasan@yandex.com").name("Hasan").
                surName("Bayindir").password("123").telephone("123").build();
